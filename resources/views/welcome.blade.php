...
<header id="header" class="fixed-top">
    <div class="container d-flex align-items-center">
        ...
        <nav id="navbar" class="navbar px-4">
            <ul>
                <li><a class="nav-link scrollto" href="/">خانه</a></li>
                <a class="nav-link scrollto" href="/dashboard">مدیریت</a>

                <li><a class="nav-link scrollto" href="/packages">تعرفه ها</a></li>
                <li><a class="nav-link scrollto" href="/about-us">درباره ما</a></li>
                <li>
                </li>
        ...
        <div class="row">
            ...
            >
                ...
                <div class="d-flex justify-content-center justify-content-lg-start">
                    <a href="/register" class="btn-get-started scrollto">ثبت نام</a>
            ...
            <div class="row">
                <div class="col-lg-4" data-aos="fade-up" data-aos-delay="100">
                    <div class="box">
                        ...
                        <a href="/register" class="buy-btn">شروع کنید</a>
                    </div>
                </div>
            ...
            <div class="row">
                <div class="col-lg-5 d-flex align-items-stretch">
                    <div class="info">
                        ...
                        <div style="width: 100%"><iframe width="100%" height="100%" frameborder="0" scrolling="no" marginheight="0" marginwidth="0" src="https://maps.google.com/maps?width=100%25&amp;height=100%25&amp;hl=en&amp;q=mashhad%20pirouzi%2010+(%DA%AF%D8%B1%D9%88%D9%87%20%D9%86%D8%B1%D9%85%20%D8%A7%D9%81%D8%B2%D8%A7%D8%B1%20%D9%88%DB%8C%D8%B1%D8%A7%D8%AF)&amp;t=&amp;z=14&amp;ie=UTF8&amp;iwloc=B&amp;output=embed"><a href="https://www.gps.ie/sport-gps/">bike gps</a></iframe></div>
                    </div>
                </div>
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-3 col-md-6 footer-links">
                    ...
                    <ul>
                        <li>
                            <i class="bx bx-chevron-right"></i> <a href="/">خانه</a>
                        </li>
                        <li>
                            <i class="bx bx-chevron-right"></i> <a href="/about-us"> درباره ما</a>
                        </li>
                        <li>
                            <i class="bx bx-chevron-right"></i> <a href="/packages">خدمات</a>
                        </li>
                        <!-- <li>
                ...
                <div class="col-lg-3 col-md-6 footer-links">
                    ...
                    <ul>
                        <li>
                            <i class="bx bx-chevron-right"></i> <a href="/dashboard"> ثبت اطلاعات متقاضی</a>
                        </li>
                        <li>
                            <i class="bx bx-chevron-right"></i>
                            <a href="/dashboard">ثبت اطلاعات ملک </a>
                        </li>
                        <li>
                            <i class="bx bx-chevron-right"></i>
                            <a href="/dashboard"> سامانه پیامکی</a>
                        </li>
                        <li>
                            <i class="bx bx-chevron-right"></i> <a href="/dashboard">مدیریت مشاورین</a>
                        </li>
