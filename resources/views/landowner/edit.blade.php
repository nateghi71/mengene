                ...
                <div class="p-6 bg-white border-b border-gray-200" style="text-align: right">
                    ...
                    <form action="{{route('landowner.update',$landowner->id)}}" method="POST">
                        ...
                        <div>
                            ...
                            <select name="status">
                                <option value="1">فعال</option>
                                <option value="0" <?php if ($landowner->status == 0) echo 'selected';?>>غیر فعال
                                </option>
                            </select>
                        </div>
                        <div>
                            ...
                            <select name="is_star">
                                ...
                                <option value="1" <?php if ($landowner->is_star == 1) echo 'selected';?>>ستاره دار
                                </option>
                            </select>
                        </div>
                        <div>
                        ...
                        <div>
                            :نوع
                            <br>
                            <input type="radio" id="html" name="type" value='buy' onclick="myFunction()" checked="checked">
                            <label for="type">فروشی</label><br>
                            <input type="radio" id="css" name="type" value='rahn'
                                   onclick="meFunction()" <?php if ($landowner->type == 'rahn') echo "checked=checked";?>>
                            ...
                            {{--                                <option value="0" <?php if ($landowner->type == 0) echo 'selected';?>>فروشی</option>--}}
                            {{--                            </select>--}}
                            {{--                            @error('type')--}}
                            {{--                            <div>{{$message}}</div> @enderror--}}
                            {{--                        </div>--}}
                            <div>
                                ...
                                <input type="number" name="price" value="{{$landowner->price}}">
                                @error('price')
                                <div>{{$message}}</div> @enderror
                            </div>
                            <div id="meDIV" style=<?php if ($landowner->type == 'rahn') {
                                echo "display:block";
                            } else {
                                echo "display:none";
                            }?>>
                                <label for="rent">اجاره: </label>
                                <input type="number" name="rent" value="{{$landowner->rent}}">
                                @error('rent')
                                <div>{{$message}}</div> @enderror
                            </div>
                            <div>
                                <label for="size">متراژ: </label>
                                <input type="number" name="size" value="{{$landowner->size}}">
                                @error('size')
                            ...
                            <div>
                                ...
                                <input type="number" name="rooms" value="{{$landowner->rooms}}">
                                @error('rooms')
                                <div>{{$message}}</div> @enderror
                            </div>
                            <div>
                            ...
                            <div>
                                ...
                                <input type="date" name="expiry_date" value="{{$landowner->expiry_date}}">
                                @error('expiry_date')
                                <div>{{$message}}</div> @enderror
                            </div>
                            <br>
