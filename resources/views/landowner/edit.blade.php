                        ...
                        <div class="col-md-4">
                            <div class="form-check">
                                <label class="form-check-label" for="type_sale1">
                                    <input type="radio" class="form-check-input" name="type_sale" id="type_sale1" onclick="buyFunction()" value="buy" {{$landowner->type_sale === "buy" ? 'checked' : '' }}> خرید </label>
                            </div>
                        </div>
                        <div class="col-sm-5">
                            <div class="form-check">
                ...
                <div class="row">
                    ...
                    <div class="form-group col-md-6">
                        ...
                        <select class="form-control" name="type_work" id="type_work">
                            <option value="home" {{$landowner->type_work === "home" ? 'checked' : '' }}>خانه</option>
                            <option value="office" {{$landowner->type_work === "office" ? 'checked' : '' }}>دفتر</option>
                        </select>
                        @error('type_work')
                        <div class="alert-danger">{{$message}}</div>
                        @enderror
                    ...
                    <div class="form-group col-md-6">
                        ...
                        <select class="form-control" name="type_build" id="type_build">
                            <option value="house" {{$landowner->type_build === "house" ? 'checked' : '' }}>ویلایی</option>
                            <option value="apartment" {{$landowner->type_build === "apartment" ? 'checked' : '' }}>ساختمان</option>
                        </select>
                        @error('type_work')
                        <div class="alert-danger">{{$message}}</div>
                        @enderror
                    ...
                    <div id="myDIV" class="form-group col-md-6" style="display: block">
                        ...
                        <input type="text" name="selling_price" class="form-control" value="{{$landowner->selling_price}}" id="selling_price" placeholder="قیمت">
                        @error('selling_price')
                        <div class="alert-danger">{{$message}}</div>
                        @enderror
                    </div>
                    <div id="meDIV1" class="form-group col-md-6" style="display: none">
                        ...
                        <input type="text" name="rahn_amount" class="form-control" value="{{$landowner->rahn_amount}}" id="rahn_amount" placeholder="رهن">
                        @error('rahn_amount')
                        <div class="alert-danger">{{$message}}</div>
                        @enderror
                    </div>
                    <div id="meDIV2" class="form-group col-md-6" style="display: none">
                        ...
                        <input type="text" name="rent_amount" class="form-control" value="{{$landowner->rent_amount}}" id="rent_amount" placeholder="اجاره">
                        @error('rent_amount')
                        <div class="alert-danger">{{$message}}</div>
                        @enderror
                    </div>
                    ...
                    <div class="form-group col-md-6">
                        ...
                        <select class="form-control" name="elevator" id="elevator">
                            <option value="0" {{$landowner->elevator === 0 ? 'checked' : '' }}>ندارد</option>
                            <option value="1" {{$landowner->elevator === 1 ? 'checked' : '' }}>دارد</option>
                        </select>
                        @error('elevator')
                        <div class="alert-danger">{{$message}}</div>
                        @enderror
                    ...
                    <div class="form-group col-md-6">
                        ...
                        <select class="form-control" name="parking" id="parking">
                            <option value="0" {{$landowner->parking === 0 ? 'checked' : '' }}>ندارد</option>
                            <option value="1" {{$landowner->parking === 1 ? 'checked' : '' }}>دارد</option>
                        </select>
                        @error('parking')
                        <div class="alert-danger">{{$message}}</div>
                        @enderror
                    ...
                    <div class="form-group col-md-6">
                        ...
                        <select class="form-control" name="store" id="store">
                            <option value="0" {{$landowner->store === 0 ? 'checked' : '' }}>ندارد</option>
                            <option value="1" {{$landowner->store === 1 ? 'checked' : '' }}>دارد</option>
                        </select>
                        @error('store')
                        <div class="alert-danger">{{$message}}</div>
                        @enderror
                    ...
                    <div class="form-group col-md-6">
                        ...
                        <select class="form-control" name="is_star" id="is_star">
                            <option value="0" {{$landowner->is_star === 0 ? 'checked' : '' }}> بدون ستاره</option>
                            <option value="1" {{$landowner->is_star === 1 ? 'checked' : '' }}>ستاره دار</option>
                        </select>
                        @error('is_star')
                        <div class="alert-danger">{{$message}}</div>
                        @enderror
