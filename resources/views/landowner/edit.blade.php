...
@section('content')
    <div class="card row">
        <div class="card-body px-5 py-4">
            ...
            <form action="{{route('landowner.update' , $landowner->id)}}" method="post" enctype="multipart/form-data" autocomplete="off">
                @csrf
                @method('PUT')
                        ...
                        <div class="col-sm-3">
                            <div class="form-check">
                                <label class="form-check-label" for="type_sale1">
                                    <input type="radio" class="form-check-input" name="type_sale" id="type_sale1" onclick="buyFunction()" value="buy" {{$landowner->getRawOriginal('type_sale') === "buy" ? 'checked' : '' }}> فروش </label>
                            </div>
                        </div>
                        <div class="col-sm-4">
                            <div class="form-check">
