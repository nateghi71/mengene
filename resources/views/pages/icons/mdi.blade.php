    ...
    <div class=" container-scroller">
      ...
      <nav class="sidebar sidebar-offcanvas" id="sidebar">
        <div class="sidebar-brand-wrapper d-none d-lg-flex align-items-center justify-content-center fixed-top">
          <a class="sidebar-brand brand-logo" href="../../dashboard.blade.php"><img src="../../assets/images/logo.svg" alt="logo" /></a>
          <a class="sidebar-brand brand-logo-mini" href="../../dashboard.blade.php"><img src="../../assets/images/logo-mini.svg" alt="logo" /></a>
        </div>
        <ul class="nav">
          ...
          <li class="nav-item menu-items">
            ...
            <div class="collapse" id="ui-basic">
              <ul class="nav flex-column sub-menu">
                <li class="nav-item"> <a class="nav-link" href="../ui-features/buttons.blade.php">Buttons</a></li>
                <li class="nav-item"> <a class="nav-link" href="../ui-features/dropdowns.blade.php">Dropdowns</a></li>
                <li class="nav-item"> <a class="nav-link" href="../ui-features/typography.blade.php">Typography</a></li>
              </ul>
            </div>
          </li>
          <li class="nav-item menu-items">
            <a class="nav-link" href="../forms/basic_elements.blade.php">
              <span class="menu-icon">
          ...
          <li class="nav-item menu-items">
            <a class="nav-link" href="../tables/basic-table.blade.php">
              <span class="menu-icon">
          ...
          <li class="nav-item menu-items">
            <a class="nav-link" href="../charts/chartjs.blade.php">
              <span class="menu-icon">
          ...
          <li class="nav-item menu-items">
            <a class="nav-link" href="mdi.blade.php">
              <span class="menu-icon">
          ...
          <li class="nav-item menu-items">
            ...
            <div class="collapse" id="auth">
              <ul class="nav flex-column sub-menu">
                <li class="nav-item"> <a class="nav-link" href="../samples/blank-page.blade.php"> Blank Page </a></li>
                <li class="nav-item"> <a class="nav-link" href="../samples/error-404.blade.php"> 404 </a></li>
                <li class="nav-item"> <a class="nav-link" href="../samples/error-500.blade.php"> 500 </a></li>
                <li class="nav-item"> <a class="nav-link" href="../samples/login.blade.php"> Login </a></li>
                <li class="nav-item"> <a class="nav-link" href="../samples/register.blade.php"> Register </a></li>
              </ul>
            </div>
          </li>
          <li class="nav-item menu-items">
      ...
      <div class="container-fluid page-body-wrapper">
        ...
        <nav class="navbar p-0 fixed-top d-flex flex-row">
          <div class="navbar-brand-wrapper d-flex d-lg-none align-items-center justify-content-center">
            <a class="navbar-brand brand-logo-mini" href="../../dashboard.blade.php"><img src="../../assets/images/logo-mini.svg" alt="logo" /></a>
          </div>
