          ...
          <li class="nav-item menu-items">
            ...
            <div class="collapse" id="ui-basic">
              <ul class="nav flex-column sub-menu">
                <li class="nav-item"> <a class="nav-link" href="buttons.blade.php">Buttons</a></li>
                <li class="nav-item"> <a class="nav-link" href="dropdowns.blade.php">Dropdowns</a></li>
                <li class="nav-item"> <a class="nav-link" href="typography.blade.php">Typography</a></li>
              </ul>
            </div>
          </li>
          <li class="nav-item menu-items">
