...
@section('content')
    <div class="card row">
        <div class="card-body px-5 py-4">
            <form action="{{route('customer.update' , $customer->id)}}" method="post" id="file_form">
                @csrf
                @method('PUT')
                        ...
                        <div class="col-sm-3">
                            <div class="form-check">
                                <label class="form-check-label" for="type_sale1">
                                    <input type="radio" class="form-check-input" name="type_sale" id="type_sale1" value="buy" @checked($customer->getRawOriginal('type_sale') === "buy")> خرید </label>
                            </div>
                        </div>
                        <div class="col-sm-4">
                            <div class="form-check">
                                <label class="form-check-label" for="type_sale2">
                                    <input type="radio" class="form-check-input" name="type_sale" id="type_sale2" value="rahn" @checked($customer->getRawOriginal('type_sale') === "rahn")> رهن و اجاره </label>
                            </div>
                        </div>
                        @error('type_sale')
                        <div class="error text-danger">{{$message}}</div>
