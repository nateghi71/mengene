...
@section('content')
    <div class="card row">
        <div class="card-body px-5 py-4">
            <form action="{{route('customer.store')}}" method="post" id="file_form">
                @csrf
                        ...
                        <div class="col-sm-3">
                            <div class="form-check">
                                <label class="form-check-label" for="type_sale1">
                                    <input type="radio" class="form-check-input" name="type_sale" id="type_sale1" value="buy" @checked(old('type_sale') == 'buy' || old('type_sale') == null)> خرید </label>
                            </div>
                        </div>
                        <div class="col-sm-4">
                            <div class="form-check">
                ...
                <div class="row">
                    ...
                    <div id="documentDiv" class="form-group col-md-3">
                        ...
                        <select class="form-control" name="document" id="document">
                            <option value="all" @selected(old('document') == 'all')>همه</option>
